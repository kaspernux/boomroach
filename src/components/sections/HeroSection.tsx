...
export function HeroSection() {
  ...
  const stats = [
    { label: 'Holders', value: '24.7K', icon: <Users className="w-4 h-4" />, color: 'neon-blue' },
    { label: 'Win Rate', value: '94.7%', icon: <Target className="w-4 h-4" />, color: 'neon-green' },
    { label: 'Market Cap', value: '$4.2M', icon: <TrendingUp className="w-4 h-4" />, color: 'nuclear-glow' },
    { label: 'Total Trades', value: '127K', icon: <Activity className="w-4 h-4" />, color: 'neon-orange' }
  ]
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="nuclear-gradient hover-glow text-xl px-12 py-6 font-bold group shadow-2xl"
              >
                <Bot className="w-6 h-6 mr-3 group-hover:animate-pulse" />
                Start Trading with Hydra Bot
                <span className="ml-3 text-sm bg-background/20 px-2 py-1 rounded">94.7% Win Rate</span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  size="lg"
                  variant="outline"
                  className="text-base px-6 py-3 border-neon-green text-neon-green hover:bg-neon-green/10"
                >
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  size="lg"
                  variant="outline"
                  className="text-base px-6 py-3 border-neon-blue text-neon-blue hover:bg-neon-blue/10"
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  size="lg"
                  variant="ghost"
                  className="text-base px-6 py-3 text-muted-foreground hover:text-neon-orange"
                  onClick={() => {
      ...
      >
        <img
          ...
          alt="Nuclear-powered roach mascot with glowing effects"
      ...
      >
        <img
          ...
          alt="BoomRoach army community illustration"
