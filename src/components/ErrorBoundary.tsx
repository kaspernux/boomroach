          ...
          <Card className="glassmorphism border-red-500/30 bg-red-500/5 max-w-2xl w-full">
            <CardHeader className="text-center">
              ...
              <p className="text-muted-foreground mt-2">
                The roach encountered an unexpected error, but we're still unkillable!
                Try one of the recovery options below to get back on track.
              </p>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 rounded-lg bg-background/50 border border-border/50">
                <h4 className="font-semibold text-sm mb-3">Quick Troubleshooting:</h4>
              ...
              <div className="text-center p-4 rounded-lg bg-neon-green/5 border border-neon-green/20">
                <p className="text-sm text-neon-green">
                  💡 <strong>Pro Tip:</strong> Most errors are temporary - refreshing usually fixes it!
